...
@task7 = @admin.tasks.create!(name: "Task7", employee_id: @emp2.id, priority: 1, repeat: "yearly")
@task8 = @admin.tasks.create!(name: "Task8", employee_id: @hrd.id, priority: 2, repeat: "monthly")
@task9 = @emp1.tasks.create!(name: "Task9", employee_id: @admin.id, priority: 3, repeat: "weekly")
@task10 = @emp2.tasks.create!(name: "Task10", employee_id: @admin.id, priority: 1, repeat: "daily")
category_arr = ["Exams", "Birthday", "Campus", "Mock Test", "Interview", "Event", "Hiring"]
